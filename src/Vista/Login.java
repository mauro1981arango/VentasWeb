...
public class Login extends javax.swing.JFrame {
    ...
    //Cremos el método que nos permite validar el correo y el pass del usuaros
    public void validar() {
        correo = txtUsuario.getText();
        pass = String.valueOf(txtContrasena.getPassword());
        //Con un if verificamos que los campos de texto nos se encuentren vacíos.
        if (!"".equals(correo) || !"".equals(pass)) {
            l = ldao.log(correo, pass);
            //Con un if verificamos que los parámetros que nos estén vacíos.
            if (l.getCorreo() != null && l.getPass() != null) {
                //Si los parámetros son correctos y no están vacíos hacemos visible nuestra vista principal llamada Sistema.java.
                Sistema sis = new Sistema(l);
                //Finalmente hacemos visible nuestro Sistema.
                sis.setVisible(true);
                //Ocultamos el login.
                dispose();
            }else{
                lblMensaje.setText("Correo o contraseña incorrecta");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 10, 320, 350));
        ...
        jLabel1.setText(" ");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 310, 370));
